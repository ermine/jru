...
const char* enum_pubsub_event_collection_type_type_to_string(enum pubsub_event_collection_type_type_t);
...
const char* enum_pubsub_event_subscription_subscription_to_string(enum pubsub_event_subscription_subscription_t);
...
int pubsub_event_event_encode(xmlWriter_t* writer, struct pubsub_event_event_t* data);
struct pubsub_event_collection_t* pubsub_event_collection_decode(xmlTextReaderPtr reader);
int pubsub_event_collection_encode(xmlWriter_t* writer, struct pubsub_event_collection_t* data);
struct pubsub_event_configuration_t* pubsub_event_configuration_decode(xmlTextReaderPtr reader);
int pubsub_event_configuration_encode(xmlWriter_t* writer, struct pubsub_event_configuration_t* data);
struct pubsub_event_delete_t* pubsub_event_delete_decode(xmlTextReaderPtr reader);
int pubsub_event_delete_encode(xmlWriter_t* writer, struct pubsub_event_delete_t* data);
struct pubsub_event_items_t* pubsub_event_items_decode(xmlTextReaderPtr reader);
int pubsub_event_items_encode(xmlWriter_t* writer, struct pubsub_event_items_t* data);
struct pubsub_event_item_t* pubsub_event_item_decode(xmlTextReaderPtr reader);
int pubsub_event_item_encode(xmlWriter_t* writer, struct pubsub_event_item_t* data);
struct pubsub_event_purge_t* pubsub_event_purge_decode(xmlTextReaderPtr reader);
int pubsub_event_purge_encode(xmlWriter_t* writer, struct pubsub_event_purge_t* data);
struct pubsub_event_retract_t* pubsub_event_retract_decode(xmlTextReaderPtr reader);
int pubsub_event_retract_encode(xmlWriter_t* writer, struct pubsub_event_retract_t* data);
struct pubsub_event_subscription_t* pubsub_event_subscription_decode(xmlTextReaderPtr reader);
int pubsub_event_subscription_encode(xmlWriter_t* writer, struct pubsub_event_subscription_t* data);
#endif
